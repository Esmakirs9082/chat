...
const MessageInput = forwardRef<MessageInputHandle, MessageInputProps>(
  function MessageInput(
    { character, onSendMessage, disabled = false, placeholder, className },
    ref
  ) {
    ...
    const isCharNearLimit =
      limits.chars > 0 && message.length > limits.chars * 0.8;
    const isMessagesOverLimit =
      limits.messages > 0 && messagesCount >= limits.messages;
    ...
    return (
      ...
      >
        ...
        {(isCharOverLimit || isMessagesOverLimit) &&
        ...
        <div className="flex items-center justify-between mt-2 text-xs text-gray-500">
          <div className="flex items-center space-x-3">
            ...
            {isTyping && (
              <span className="text-blue-500 animate-pulse">Печатаете...</span>
            )}
          </div>
        </div>
